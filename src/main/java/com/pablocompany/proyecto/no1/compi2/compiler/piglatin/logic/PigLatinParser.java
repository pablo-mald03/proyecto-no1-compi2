...
public class PigLatinParser extends Parser {
	...
	public static final int
		...
		RULE_struct_instance = 31, RULE_struct_literal = 32, RULE_struct_data_list = 33, 
		RULE_struct_data_value = 34, RULE_nest_variable = 35, RULE_object_values = 36, 
		RULE_arguments_list = 37, RULE_expression = 38, RULE_variable_type = 39, 
		RULE_normal_values = 40, RULE_boolean_values = 41, RULE_abbreviated_operation = 42;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"array_declaration", "array_initialization", "values_array_list", "struct_instance", 
			"struct_literal", "struct_data_list", "struct_data_value", "nest_variable", 
	...
	public final Struct_literalContext struct_literal() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_struct_literal);
		try {
	...
	public final Struct_data_listContext struct_data_list() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_struct_data_list);
		int _la;
		try {
	...
	public final Struct_data_valueContext struct_data_value() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_struct_data_value);
		try {
	...
	public final Nest_variableContext nest_variable() throws RecognitionException {
		...
		enterRule(_localctx, 70, RULE_nest_variable);
		try {
	...
	private Object_valuesContext object_values(int _p) throws RecognitionException {
		...
		int _startState = 72;
		enterRecursionRule(_localctx, 72, RULE_object_values, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Variable_typeContext variable_type() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_variable_type);
		try {
			setState(474);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Abbreviated_operationContext abbreviated_operation() throws RecognitionException {
		...
		enterRule(_localctx, 84, RULE_abbreviated_operation);
		try {
			setState(513);
			_errHandler.sync(this);
