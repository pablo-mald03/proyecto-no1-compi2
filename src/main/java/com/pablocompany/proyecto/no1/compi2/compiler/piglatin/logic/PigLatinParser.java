...
public class PigLatinParser extends Parser {
	...
	public static final int
		...
		RULE_struct_instance = 30, RULE_struct_literal = 31, RULE_struct_data_list = 32, 
		RULE_struct_data_value = 33, RULE_nest_variable = 34, RULE_object_values = 35, 
		RULE_arguments_list = 36, RULE_expression = 37, RULE_variable_type = 38, 
		RULE_normal_values = 39, RULE_boolean_values = 40, RULE_abbreviated_operation = 41;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"array_initialization", "values_array_list", "struct_instance", "struct_literal", 
			"struct_data_list", "struct_data_value", "nest_variable", "object_values", 
			"arguments_list", "expression", "variable_type", "normal_values", "boolean_values", 
	...
	public final Struct_instanceContext struct_instance() throws RecognitionException {
		...
		enterRule(_localctx, 60, RULE_struct_instance);
		try {
	...
	public final Struct_data_listContext struct_data_list() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_struct_data_list);
		int _la;
		try {
	...
	public final Struct_data_valueContext struct_data_value() throws RecognitionException {
		...
		enterRule(_localctx, 66, RULE_struct_data_value);
		try {
	...
	public final Nest_variableContext nest_variable() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_nest_variable);
		try {
	...
	private Object_valuesContext object_values(int _p) throws RecognitionException {
		...
		int _startState = 70;
		enterRecursionRule(_localctx, 70, RULE_object_values, _p);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final Variable_typeContext variable_type() throws RecognitionException {
		...
		enterRule(_localctx, 76, RULE_variable_type);
		try {
			setState(454);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
	...
	public final Abbreviated_operationContext abbreviated_operation() throws RecognitionException {
		...
		enterRule(_localctx, 82, RULE_abbreviated_operation);
		try {
			setState(493);
			_errHandler.sync(this);
