...
@Getter
public class IncrementPrevStatementNodeZ extends ExpressionNodeZ {
    private final ExpressionNodeZ targetVariable;
    private final AbreviationOperator abreviationOperator;

    public IncrementPrevStatementNodeZ(int line, int column, AbreviationOperator abreviationOperator, ExpressionNodeZ targetVariable) {
        super(line, column);
