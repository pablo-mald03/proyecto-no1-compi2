...
@Getter
public class DecrementPrevStatementNode extends ExpressionNode {
    private final ExpressionNode targetVariable;
    private final AbreviationOperator abreviationOperator;

    public DecrementPrevStatementNode(int line, int column, AbreviationOperator abreviationOperator, ExpressionNode targetVariable) {
        super(line, column);
