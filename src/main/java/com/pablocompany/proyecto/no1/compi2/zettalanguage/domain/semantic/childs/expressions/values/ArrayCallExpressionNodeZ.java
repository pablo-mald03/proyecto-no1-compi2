...
@Getter
@Setter
public class ArrayCallExpressionNodeZ extends ExpressionNodeY {
    ...
    public ArrayCallExpressionNodeZ(int line, int column, String arrayName, ExpressionNodeY indexExpression) {
        super(line, column);
