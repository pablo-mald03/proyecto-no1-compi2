...
public class IfStatementNodeY extends StatementNodeY {
    ...
    private final List<StatementNodeY> thenBody;
    private final List<ElseIfNodeY> elseIfs;
    private final ElseBlockNodeY elseBlockNode;

    public IfStatementNodeY(int line, int column, ExpressionNodeY condition, List<StatementNodeY> thenBody, List<ElseIfNodeY> elseIfs, ElseBlockNodeY elseBlockNode) {
        super(line, column);
