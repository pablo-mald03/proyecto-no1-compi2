...
@Getter
public class IncrementStatementNodePigLatin extends ExpressionNodePigLatin {
    private final ExpressionNodePigLatin targetVariable;
    private final AbreviationOperator abreviationOperator;

    public IncrementStatementNodePigLatin(int line, int column, AbreviationOperator abreviationOperator, ExpressionNodePigLatin targetVariable) {
        super(line, column);
