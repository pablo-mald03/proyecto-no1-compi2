...
@Getter
public class DecrementStatementNodeZ extends ExpressionNodeZ {
    private final ExpressionNodeZ targetVariable;
    private final AbreviationOperator abreviationOperator;

    public DecrementStatementNodeZ(int line, int column, AbreviationOperator abreviationOperator, ExpressionNodeZ targetVariable) {
        super(line, column);
