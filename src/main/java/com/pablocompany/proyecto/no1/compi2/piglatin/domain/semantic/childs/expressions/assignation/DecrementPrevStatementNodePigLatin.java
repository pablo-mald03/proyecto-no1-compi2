...
@Getter
public class DecrementPrevStatementNodePigLatin extends ExpressionNodePigLatin {
    private final ExpressionNodePigLatin targetVariable;
    private final AbreviationOperator abreviationOperator;

    public DecrementPrevStatementNodePigLatin(int line, int column, AbreviationOperator abreviationOperator, ExpressionNodePigLatin targetVariable) {
        super(line, column);
